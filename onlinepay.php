...
<html>
  ...
  <head>
    <title> Online Payment | Food Zone </title>
  </head>
...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Check if expiration date is entered
        if (empty($expirationDate)) {
            echo "Please enter the expiration date.";
            exit;
        }

        // Check if CVV is entered
        if (empty($cvv)) {
            echo "Please enter the CVV.";
            exit;
        }

        // Process the payment with the provided card details
        // You can use a payment gateway API for this, such as Stripe or PayPal
        // Write the code to handle payment processing here
