      ...
      <div class="collapse navbar-collapse " id="myNavbar">
        ...
        if (isset ($_SESSION['login_user1'])) {
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><span class=""></span> Welcome
          ...
          ?>
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="active"><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Food Zone </a>
              </li>
          ...
          ?>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true"
                  aria-expanded="false"><span class=""></span> Sign Up <span class="caret"></span>
                </a>
        ...
        <div class="col-md-3">
          ...
          <form method="post" action="cart.php?action=add&id=<?php echo $row["F_ID"]; ?>">
            <div class="mypanel" align="center" ;>
              ...
              <h5 class="text-info">Quantity: <input type="number" min="1" max="25" name="quantity" class="form-control"
                  value="1" style="width: 60px;"> </h5>
